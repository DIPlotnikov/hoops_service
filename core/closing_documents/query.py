...
from closing_documents.input import (
    InputForManagerQueryClosingDocuments,
    InputForQueryClosingDocument,
    InputForQueryClosingDocuments,
)
from closing_documents.models import ClosingDocument
from closing_documents.type import ClosingDocumentType
from hotels.models import RoleAdmin
from hotels.schemas.schema_handler import is_admin, is_manager
